...
from wanderai.agent.model import Hotspot
from wanderai.common.database import redis
from wanderai.common.log import log
from wanderai.model.vo import HotspotVO
from wanderai.server.agent import HotspotAgent
