...
from wanderai.common.database import init_db
from wanderai.server.controller import (
    AdminController,
    ChatController,
    HistoryController,
    HotspotController,
...
from wanderai.server.handler import setup_exception_handler
from wanderai.server.interceptor import setup_middlewares
